...
import server.service.impl.OtwImplementation;
import utlis.Utils;
...
public class OtwServer {
    private static OtwImplementation implementation;
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            implementation = new OtwImplementation();
            Endpoint.publish("http://localhost:" + Utils.OTW_SERVER_PORT + "/otw", implementation);
        }
        catch (Exception re) {
