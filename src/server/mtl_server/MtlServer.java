...
import server.service.impl.MtlImplementation;
import utlis.Utils;
...
public class MtlServer {
    ...
    private static MtlImplementation implementation;
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            implementation = new MtlImplementation();
            Endpoint.publish("http://localhost:" + Utils.MTL_SERVER_PORT + "/mtl", implementation);
        }
        catch (Exception re) {
